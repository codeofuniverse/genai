  ...
  const createBooking = async () => {
    ...
    try {
      ...
      if (sessionType == "video") {
        ...
        const recipient = selectedCounsellor.email;
        const subject = bookingData.title;
...
- Title: ${bookingData.title}
- Description: ${bookingData.description}
- Counsellor Name: ${selectedCounsellor.full_name}
- Session Date: ${sessionDateTime.toLocaleString()}
...
`;
        ...
        bookingPayload = {
          ...
          duration_minutes: parseInt(bookingData.duration_minutes),
          session_type: sessionType,
          session_url: "https://mail.google.com/mail/u/0/#sent",
        };
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                        ...
                        {format(new Date(booking.session_date), "p")} •{" "}
                      ...
                      {booking.status === "scheduled" && (
                        <div className="pt-3 border-t">
                          <Button
                            onClick={() => JoinMeeting(booking.session_url)}
                            size="sm"
                            className="w-full"
                          >
                            Join Session
